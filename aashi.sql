...
--
-- Host: localhost
-- Generation Time: Feb 20, 2025 at 09:40 AM
...
CREATE TABLE `users_directory` (
  ...
  `users_email` varchar(360) COLLATE utf8mb4_general_ci NOT NULL,
  `users_contact` varchar(360) COLLATE utf8mb4_general_ci NOT NULL,
  `users_password` varchar(360) COLLATE utf8mb4_general_ci NOT NULL,
  `users_uniqueID` varchar(360) COLLATE utf8mb4_general_ci NOT NULL,
  `user_avatar` varchar(360) COLLATE utf8mb4_general_ci NOT NULL,
  `present_friend_status` varchar(360) COLLATE utf8mb4_general_ci NOT NULL,
  `present_live_status` varchar(360) COLLATE utf8mb4_general_ci NOT NULL,
...
(5, 'Vivek Kumar Sharma', 'viveksharma@gmail.com', '9974331561', '$2y$10$Zo9RH2j9r634U42o5cwaOucvZnBYPge3BUbROH2KoIlUfDkD8Pru6', 'VIVCJBO950', 'avatar16.png', 'Not a Friend', 'Offline', '2025-02-19 19:44:46'),
